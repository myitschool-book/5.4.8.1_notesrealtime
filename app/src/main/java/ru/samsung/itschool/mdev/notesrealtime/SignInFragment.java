...
import ru.samsung.itschool.mdev.notesrealtime.databinding.FragmentSignInBinding;
...
public class SignInFragment extends BaseFragment implements View.OnClickListener {
    ...
    private void onAuthSuccess(FirebaseUser user) {
        ...
        // Go to recentPostsFragment
        NavHostFragment.findNavController(this).navigate(R.id.action_signInFragment_to_noteListFragment);
    }
